...
class Arr extends ScalarObject implements \ArrayAccess, \Serializable, \Countable, \Iterator
{
    ...
    {
        if (!$this->exists($key)) {
            throw new \RuntimeException("array key not exists: $key");
        }
    ...
    {
        $this->array = (array)json_decode((string)$string,true);
        return $this;
    }
    ...
    public function append(...$values): Arr
    {
