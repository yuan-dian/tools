...
final class StatusCode
{
    ...
    {
        return self::REASON_PHRASES[$code] ?? 'Unknown';
    }
     ...
     * 是否需要身份验证
     */
    public static function requiresAuth(int $code): bool
    {
        return in_array($code, [self::UNAUTHORIZED, self::PROXY_AUTH_REQUIRED], true);
    }
}